...
子どもと一緒に遊べるトイドローンや100g未満の軽量ドローンで撮った映像が、ガタガタで観にくくなってしまって活用できていないことに気づき、何とかしたいなと思っていました。Google Colabのサイトに、Geminiが伴走してくれるようになったので、Geminiとの対話でコーディングできましたので、シェアします。
